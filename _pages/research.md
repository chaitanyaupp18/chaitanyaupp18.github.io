...
<div class="research-projects">
    ...
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-sm-12 mt-3 mt-md-0 mb-3">
          {% include figure.liquid loading="eager" path="assets/img/publication_preview/prefix_infographic.png" class="img-fluid rounded z-depth-1" %}
        </div>
        <div class="col-sm-12">
          ...
          <p><a href="https://dl.acm.org/doi/10.1145/3696443.3708960" target="_blank">Paper</a> · <a href="https://research.google/pubs/prefix-optimizing-the-performance-of-heap-intensive-applications/" target="_blank">Verified abstract</a></p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="card mb-4">
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-sm-12 mt-3 mt-md-0 mb-3">
          {% include figure.liquid loading="eager" path="assets/img/publication_preview/dedubb_infographic.png" class="img-fluid rounded z-depth-1" %}
        </div>
        <div class="col-sm-12">
          ...
          <p><a href="https://dl.acm.org/doi/10.1145/3814943.3816169" target="_blank">Paper</a> · <a href="https://research.google/pubs/dedubb-binary-code-size-reduction-via-post-link-basic-block-de-duplication/" target="_blank">Verified abstract</a></p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="card mb-4">
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-sm-12 mt-3 mt-md-0 mb-3">
          {% include figure.liquid loading="eager" path="assets/img/publication_preview/ai_propeller_infographic.png" class="img-fluid rounded z-depth-1" %}
        </div>
        <div class="col-sm-12">
